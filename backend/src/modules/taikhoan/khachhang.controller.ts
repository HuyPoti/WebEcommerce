...
export class KhachHangController {
  ...
  async update(
    ...
    throw new Error('KhÃ´ng cÃ³ quyá»n cáº­p nháº­t');
  }
  ...
  async updateStatus(
    ...
    throw new Error('KhÃ´ng cÃ³ quyá»n cáº­p nháº­t tráº¡ng thÃ¡i');
  }
}
